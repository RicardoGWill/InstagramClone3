package com.ibginstitute.instagramclone3.profileuser;
...
import com.ibginstitute.instagramclone3.R;
import com.ibginstitute.instagramclone3.instagramposthome.InstagramHome;
...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userStatusEditText = (EditText) findViewById(R.id.userProfileStatus);
    ...
    private void saveUserProfile() {
        ...
        userStatus = userStatusEditText.getText().toString().trim();
